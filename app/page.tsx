          ...
          <div className="border-t border-[var(--border-base)]">
            {[
              ...
              },
              {
                ...
                a: 'Sonant briefs are curated by the Sonant team and written to real industry specs. Accepted tracks get added to the catalog and pitched to buyers. Community briefs are generated by composers using the Brief Generator. Anyone can write to them and upload their track. No review process, just practice.',
              },
              {
              ...
              },
              {
                ...
                a: 'You can browse all briefs without an account. An account is required to submit to Sonant briefs, upload to community briefs, or generate your own. Creating one is free.',
              },
            ].map(({ q, a }) => (
              <div
                key={q}

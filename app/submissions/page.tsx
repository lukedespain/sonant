  ...
  return (
    <div className="pt-20 pb-12 flex-1">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <p className="text-base md:text-lg text-[var(--text-tertiary)] mb-10 max-w-2xl leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="max-w-2xl mb-20">
          <p className="text-base md:text-lg text-[var(--text-tertiary)] mb-8 leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="max-w-2xl mb-12">
          <p className="text-base md:text-lg text-[var(--text-tertiary)] mb-10 leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="border-t border-[var(--border-base)] mb-20" />
        {/* NOT SURE YET */}
        <div className="border border-[var(--border-card)] bg-[var(--bg-card)] p-8 md:p-12 max-w-3xl" style={{ borderRadius: '2px' }}>
          <div className="text-[10px] tracking-[0.3em] uppercase text-[#E85D2F] mb-4" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
            ◆ Not Sure Yet?
          </div>
          <p className="text-base md:text-lg text-[var(--text-secondary)] mb-3 leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          ...
          <p className="text-base text-[var(--text-tertiary)] mb-8 leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>
